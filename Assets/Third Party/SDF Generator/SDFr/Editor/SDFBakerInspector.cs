...
namespace SDFr.Editor
{
    ...
    [CustomEditor(typeof(SDFBaker),true)]
    public class SDFBakerInspector : AVolumeBakerInspector<SDFBaker,SDFVolume,SDFData>
    {
        ...
        private SerializedProperty bakerNameProperty;
        ...
        private const string strBakerName = "bakerName";
        ...
        protected override void CollectSerializedProperties()
        {
            ...
            bakerNameProperty = serializedObject.FindProperty(strBakerName);
        }
		...
		protected override void DrawVolumeGUI()
		{
            ...
            EditorGUILayout.PropertyField(bakerNameProperty);
			
            BakeControls((BakerName)bakerNameProperty.enumValueIndex);
        ...
        private void BakeControls(BakerName bakerName)
        {
            SDFBaker baker = target as SDFBaker;
            if (baker == null) return;
            if (GUILayout.Button(StrBake))
            {
                switch(bakerName)
                {
                    case BakerName.CPU: baker.BakeOnCPU(); break;
                    case BakerName.GPU: baker.Encapsulate(); baker.BakeOnGPU(); break;
                }
            }
